...
requireLogin();
requireAdmin(); // Nanti ganti jadi requirePetugas() kalau ini diakses petugas
...
<div class="flex bg-slate-50 min-h-screen">
    ...
    <main class="flex-1 p-8 overflow-y-auto">
        <div class="max-w-6xl mx-auto">
            <h1 class="text-2xl font-extrabold text-slate-900 mb-6" data-aos="fade-down">Kelola Transaksi</h1>
